...
public class ChebyshevPath{
 ...
 // does the system percolate vertically in a direct way?
    ...
    // draw the N-by-N boolean matrix and including the points A (x1, y1) and B (x2,y2) to be marked by a circle
    ...
    public static void main(String[] args) {
     ...
     // Stop the timer and display time elapsed
        ...
        for (DijkstrasChebyshev.Node node : path2) {
            StdDraw.filledSquare(node.y, randomlyGenMatrix2.length - node.x - 1, .5);
        }
