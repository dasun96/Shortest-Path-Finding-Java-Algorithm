 ...
 */
public class PathFindingOnSquaredGrid1 {
 ...
 // does the system percolate vertically in a direct way?
    ...
    public static void main(String[] args) {
     ...
     // THIS IS AN EXAMPLE ONLY ON HOW TO USE THE JAVA INTERNAL WATCH
        ...
        ArrayList<Dijkstras.Node> path = new Dijkstras().distance(randomlyGenMatrix, Ai, Aj, Bi, Bj);
        ...
        if (path.isEmpty()) {
                    System.out.println("No path found using Manhattan method \n");
                } else {
